...
class EntryPolicy
{
     ...
     * 
     */
    public function update(User $user, Entry $entry) // user guest use (?User $users)
    {
      return $user->id === $entry->member_id 
        ? Response::allow() 
        : Response::deny('You do not own this post');
        // return $ptional($user)->id === $post->user_id; for user guest 
    }
